...
function renderCurrentDay(cityName, data) {
  ...
  if (uv >= 0 && uv < 3) {
    indexUV.setAttribute(
      "style",
      "background: green; border-style: solid; width:fit-content; color:white;text-align: center;"
    );
  } else if (uv >= 3 && uv < 6) {
    indexUV.setAttribute(
      "style",
      "background: yellow; border-style: solid; width:fit-content;text-align: center;"
    );
  } else if (uv >= 6 && uv < 7) {
    indexUV.setAttribute(
      "style",
      "background: orange; border-style: solid; width:fit-content;text-align: center;"
    );
  } else {
    indexUV.setAttribute(
      "style",
      "background: red; border-style: solid; width:fit-content; color:whitetext-align: center;"
    );
  }
...
function renderFiveDay(data) {
  ...
  icon0.innerHTML =
    "<img src=http://openweathermap.org/img/wn/" + icon0image + ".png>";
  ...
  icon1.innerHTML =
    "<img src=http://openweathermap.org/img/wn/" + icon1image + ".png>";
  ...
  icon2.innerHTML =
    "<img src=http://openweathermap.org/img/wn/" + icon2image + ".png>";
  ...
  icon3.innerHTML =
    "<img src=http://openweathermap.org/img/wn/" + icon3image + ".png>";
